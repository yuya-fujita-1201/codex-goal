...
6. プロンプトに「📨 ユーザーからの追加指示」セクションがあれば、ターン本文の冒頭で各メッセージに対し \`<user-reply id="...">短い返答</user-reply>\` を出力すること。返答後に通常作業を進める。
...
const PID_SUBDIRS = ['turns', 'blocks', 'judge', 'compressor'] as const
